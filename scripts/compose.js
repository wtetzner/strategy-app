...
function invertStrategies(team, strategy) {
  var otherTeam = team === "ally" ? "enemy" : "ally";
  ...
  $(".strategy-" + otherTeam).each(function() {
...
function constructStrategyButtons() {
  $(".strategy-box").click(function() {
    ...
    if($self.hasClass("strategy-ally")) {
      invertStrategies("ally", strategy);
    } else {
      invertStrategies("enemy", strategy);
    }
